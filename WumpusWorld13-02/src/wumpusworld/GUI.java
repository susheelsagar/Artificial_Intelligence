...
public class GUI implements ActionListener
{
    ...
    static int wX=-1,wY=-1,game_count=0;
    ...
    private void createWindow()
    {
        ...
        buttons.add(ba);
        /*button added to run new map simulation*/
        JButton sim = new JButton("Run New Map Simulation");
        sim.setActionCommand("simulation");
        sim.addActionListener(this);
        buttons.add(sim);
        /*button added to Refresh memory*/
        JButton ref = new JButton("Refresh Memory");
        ...
        JLabel label = new JLabel("* On a new Map, Press REFRESH Memory -> Run New Map Simulation -> New Game -> Run Solving Agent ");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        //Code to execute the refresh code
        if (e.getActionCommand().equals("refresh"))
        {            
            agent.refresh();           
            
        }
        //Code to run the simulation behind the scenes
        ...
        {                
            ...
            // temp value represents the number of simulations
            if(i==1)
            {
                temp=50; 
            }
